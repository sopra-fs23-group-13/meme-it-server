...
| 04/04/2023-04/17/2023 | Linda Weber | [Dev Task 54](https://github.com/sopra-fs23-group-13/meme-it-client/issues/54) |As a user, during each round I want to be able to create my own meme and afterwards look at and rate each individual meme submitted by a player.|
