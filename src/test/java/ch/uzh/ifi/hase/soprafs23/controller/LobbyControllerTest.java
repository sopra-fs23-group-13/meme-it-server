...
public class LobbyControllerTest {
    ...
    public void givenLobbies_whenGetLobbies_thenReturnJsonArray() throws Exception {
        ...
        mockMvc.perform(getRequest).andExpect(status().isOk())
                ...
                .andExpect(jsonPath("$[0].lobbySetting.isPublic", is(lobby.getLobbySetting().getIsPublic())))
                .andExpect(jsonPath("$[0].lobbySetting.maxPlayers", is(lobby.getLobbySetting().getMaxPlayers())))
                .andExpect(jsonPath("$[0].lobbySetting.maxRounds", is(lobby.getLobbySetting().getMaxRounds())))
                .andExpect(
                        jsonPath("$[0].lobbySetting.memeChangeLimit", is(lobby.getLobbySetting().getMemeChangeLimit())))
                .andExpect(
                        jsonPath("$[0].lobbySetting.superLikeLimit", is(lobby.getLobbySetting().getSuperLikeLimit())))
                .andExpect(jsonPath("$[0].lobbySetting.superDislikeLimit",
                        is(lobby.getLobbySetting().getSuperDislikeLimit())))
                .andExpect(
                        jsonPath("$[0].lobbySetting.timeRoundLimit", is(lobby.getLobbySetting().getTimeRoundLimit())))
                .andExpect(jsonPath("$[0].lobbySetting.timeVoteLimit", is(lobby.getLobbySetting().getTimeVoteLimit())));
    }
    ...
    public void createLobby_validInput_userCreated() throws Exception {
        ...
        mockMvc.perform(postRequest)
                ...
                .andExpect(jsonPath("$.lobbySetting.isPublic", is(lobby.getLobbySetting().getIsPublic())))
                .andExpect(jsonPath("$.lobbySetting.maxPlayers", is(lobby.getLobbySetting().getMaxPlayers())))
                .andExpect(jsonPath("$.lobbySetting.maxRounds", is(lobby.getLobbySetting().getMaxRounds())))
                .andExpect(jsonPath("$.lobbySetting.memeChangeLimit", is(lobby.getLobbySetting().getMemeChangeLimit())))
                .andExpect(jsonPath("$.lobbySetting.superLikeLimit", is(lobby.getLobbySetting().getSuperLikeLimit())))
                .andExpect(jsonPath("$.lobbySetting.superDislikeLimit",
                        is(lobby.getLobbySetting().getSuperDislikeLimit())))
                .andExpect(jsonPath("$.lobbySetting.timeRoundLimit", is(lobby.getLobbySetting().getTimeRoundLimit())))
                .andExpect(jsonPath("$.lobbySetting.timeVoteLimit", is(lobby.getLobbySetting().getTimeVoteLimit())));
    ...
    public void givenLobbies_whenGetLobby_thenReturnJsonArray() throws Exception {
        ...
        // when
        MockHttpServletRequestBuilder getRequest = get("/lobby/1").contentType(MediaType.APPLICATION_JSON);
