...
public class GameControllerTest {
        ...
        private static ResultMatcher[] verifyRatingResponseBody(Rating rating) {
                return new ResultMatcher[] { jsonPath("$", hasSize(1)),
                                ...
                                jsonPath("$[0].meme.textBoxes[0].text",
                                                is(rating.getMeme().getTextBoxes().get(0).getText())),
                                jsonPath("$[0].meme.textBoxes[0].xRate",
                                                is(rating.getMeme().getTextBoxes().get(0).getxRate())),
                                jsonPath("$[0].meme.textBoxes[0].yRate",
                                                is(rating.getMeme().getTextBoxes().get(0).getyRate())),
                                ...
                                jsonPath("$[0].meme.user.executedSwaps",
                                                is(rating.getMeme().getUser().getExecutedSwaps())) };
        }
